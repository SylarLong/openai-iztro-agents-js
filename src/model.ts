...
/** Build the faster, lower-token, lower-cost Ziwei model with the v3 public response contract. */
...
/** Build the faster, lower-token, lower-cost Qimen model with the v3 public response contract. */
